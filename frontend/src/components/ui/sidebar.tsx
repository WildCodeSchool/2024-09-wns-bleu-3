    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-dark-blue-950 border-main-400/20 text-white w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
...
// Fix the scrollbar issue overflow with this issue : https://github.com/shadcn-ui/ui/issues/5780
