                ...
                <main className="flex-1">
                    <div className="py-8 px-6">
                        ...
                        <div className="flex items-center mb-6">
                            <Button variant="outline" size="sm" asChild className="bg-slate-800/50 border-white/10 text-slate-300 hover:text-white hover:bg-slate-700/50 hover:border-white/20">
                                <Link to="/dashboard">
                        ...
                        {/* Scan details header */}
                        <div className="flex space-around border border-white/10 bg-main-400/5 backdrop-blur-xl rounded-xl p-6 mb-6">
                            <div className="text-left flex-1">
                                <h1 className="text-3xl font-bold text-white">{scan.title}</h1>
                                <p className="text-slate-400">{scan.url}</p>
                            </div>
                        ...
                        <div className="border border-white/10 bg-main-400/5 backdrop-blur-xl rounded-xl p-6 mt-6">
                            <Tabs defaultValue="history">
                                <TabsList className="mb-4 cursor-pointer bg-slate-800/50 border-white/10">
                                    <TabsTrigger className="cursor-pointer text-slate-300 data-[state=active]:text-white data-[state=active]:bg-slate-700/50" value="history">Detailed History</TabsTrigger>
                                    <TabsTrigger className="cursor-pointer text-slate-300 data-[state=active]:text-white data-[state=active]:bg-slate-700/50" value="settings">Settings</TabsTrigger>
                                </TabsList>
